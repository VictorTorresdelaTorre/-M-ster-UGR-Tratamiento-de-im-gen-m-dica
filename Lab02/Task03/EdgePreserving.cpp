...
int main (int argc, char ** argv)
{
	...
	const unsigned int gradientAnisotropicNumberOfIterations = 3;
	...
	const unsigned int curvatureAnisotropicNumberOfIterations = 3;
	...
	description = "Gradient Anisotropic\nIterations = " + to_string(gradientAnisotropicNumberOfIterations) + ", Time Step = " + to_string(gradientAnisotropicTimeStep) + ", \nConductance = " + to_string(gradientAnistropicConductance);
	viewer.AddImage(gradientAnisotropicFilter->GetOutput(), true, description);
	description = "Curvature Anisotropic\nIterations = " + to_string(curvatureAnisotropicNumberOfIterations) + ", Time Step = " + to_string(curvatureAnisotropicTimeStep) + ", \nConductance = " + to_string(curvatureAnisotropicConductance) + ", Use spacing = " + to_string(curvatureAnisotropicUseImageSpacing);
