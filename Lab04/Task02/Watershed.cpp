...
int main(int argc, char *argv[])
{
	...
	typedef itk::CastImageFilter<RGBImageType, VectorImageType> CastFilterType;
	...
	viewer.AddImage(gradient->GetOutput(), true, description);*/
	description = "whaterShed";
	viewer.AddImage(watershed->GetOutput(), true, description);
  description = "gradiente";
	viewer.AddImage(gradient->GetOutput(), true, description);
	description = "Color map: " + to_string(conductance) + ", Iters: " + to_string(iters) + "\nThreshold: " + to_string(threshold) + ", Level: " + to_string(level) + "\nGradient Mode: " + to_string(gradientMode);
